...
public class SongArrayAdapter extends ArrayAdapter<Song> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvSong = (TextView) rowView.findViewById(R.id.textViewSong);
        TextView tvYear = (TextView) rowView.findViewById(R.id.textViewYear);
        TextView tvSinger = (TextView) rowView.findViewById(R.id.textViewSingers);
